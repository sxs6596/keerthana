export default function PrivacyPolicy() {
    return (
      <div className="container mx-auto px-4 py-10">
        <h1 className="text-4xl font-bold text-gray-400 text-center mb-10">
          Privacy Policy
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-neutral shadow-lg rounded-lg p-6 text-neutral-content shadow-indigo-500/50">
            ...
            <ul className="list-disc list-inside">
              <li>
                ...
                directly, such as your name, email address, phone number, and any
                other personal information.
              </li>
              <li>
                <strong>Usage Data:</strong> We collect information like IP
          ...
          <div className="bg-neutral shadow-lg rounded-lg p-6 text-neutral-content shadow-indigo-500/50">
            ...
            <ul className="list-disc list-inside">
              ...
              <li>
                We may share data with trusted service providers under
                confidentiality agreements.
              </li>
              <li>
                We may share information if required by law or in connection with
          ...
          <div className="bg-neutral shadow-lg rounded-lg p-6 text-neutral-content shadow-indigo-500/50">
            ...
            <p>
              ...
              various security measures to protect your data. However, no method
